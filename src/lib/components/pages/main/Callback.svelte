...
>
	...
	>
		...
		<form
			on:submit|preventDefault={() => console.log('Submited!')}
			class="flex flex-col md:flex-row gap-4 items-center mt-10 mb-6"
		>
			<input
				type="text"
			...
			<input
				...
				required
			/>
			<button type="submit" class="btn btn-primary rounded-full normal-case btn-wide just"
